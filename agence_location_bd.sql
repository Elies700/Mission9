...
--
-- Base de données : `agence_location_bd`
--
...
(12, '12TU12', 'Mercedes', 'Classe A', 2025, 150000, 12);
...
ALTER TABLE `locations`
  ...
  ADD KEY `id_client` (`id_client`,`id_employe`),
...
--
ALTER TABLE `categories`
  ADD CONSTRAINT `categories_ibfk_1` FOREIGN KEY (`id_categorie`) REFERENCES `locations` (`id_voiture`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `locations`
--
ALTER TABLE `locations`
  ADD CONSTRAINT `locations_ibfk_1` FOREIGN KEY (`id_voiture`) REFERENCES `voitures` (`id_voiture`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `locations_ibfk_3` FOREIGN KEY (`id_client`) REFERENCES `clients` (`id_client`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
