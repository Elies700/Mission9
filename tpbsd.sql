...
--
-- Hôte : localhost
-- Généré le : lun. 17 nov. 2025 à 14:06
...
(1, 'PSG', 'OM', '2025-11-17 13:07:03', 1),
(2, 'Lakers', 'Bulls', '2025-11-17 13:08:47', 2),
(3, 'Nadal', 'Federer', '2025-11-17 13:09:22', 3);
...
ALTER TABLE `pari`
  ...
  ADD KEY `id_user` (`id_user`,`id_match`,`id_typepari`),
